                        ...
                        <DialogContent className="sm:max-w-[425px] bg-slate-950 border-primary/20 text-white">
                            ...
                            <div className="grid gap-4 py-4">
                                <div className="grid gap-2">
                                    ...
                                    <Input value={newProduct.name} onChange={e => setNewProduct({...newProduct, name: e.target.value})} className="bg-slate-900 border-white/10 text-white" placeholder="Nexus Whey Protein..." />
                                </div>
