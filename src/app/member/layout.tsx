...
import SidebarContent from '@/components/member/SidebarContent';
import { NotificationProvider } from '@/context/NotificationContext';
import MemberProtected from '@/components/member/MemberProtected';
            ...
            <div className="flex h-screen overflow-hidden bg-background">
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 pb-20 lg:pb-8 scroll-smooth relative">
                        {/* Background Ambient Glow for Member Area */}
                        <div className="fixed inset-0 pointer-events-none z-0">
                            <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[radial-gradient(circle,_hsl(var(--primary)/0.03),_transparent_60%)] blur-3xl opacity-50 dark:opacity-100"></div>
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
                <SheetContent side="left" className="p-0 w-64 border-r border-slate-200 dark:border-primary/20">
                    <div className="sr-only">
                        ...
                        <SheetDescription>Navigation links for the member portal</SheetDescription>
                    </div>
            ...
            <Sheet open={isBottomMenuOpen} onOpenChange={setIsBottomMenuOpen}>
                <SheetContent side="bottom" className="p-0 rounded-t-[2rem] border-t border-slate-200 dark:border-primary/20 bg-background/95 backdrop-blur-xl max-h-[85vh] overflow-hidden flex flex-col">
                    <div className="sr-only">
                        ...
                        <SheetDescription>Bottom sheet navigation links for the member portal</SheetDescription>
                    </div>
