...
export default function TrainerTrialPage() {
    ...
    const handleSetPreferred = (trainerId: string, trainerName: string) => {
        ...
        addNotification({
            ...
            message: `${currentUser?.name || 'Alex'} (${currentUser?.email || 'member@nexusgym.com'}) has set you as their preferred coach.`,
    ...
    const handleConfirmBooking = () => {
        ...
        addNotification({
            ...
            message: `${currentUser?.name || 'Alex'} (${currentUser?.email || 'member@nexusgym.com'}) has requested a trial session with you for ${bookingDates[bookingDateIdx].formatted} at ${bookingTime}.`,
            metadata: {
                type: 'TRIAL_REQUEST',
